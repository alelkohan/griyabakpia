<form class="" id="tambahBahan">
    <div class="row">
        <div class="col-md-12">
            <div class="mb-3">
                <label for="username" class="form-label">Nama Bahan</label>
                <input type="text" name="nama_bahan" class="form-control" id="username" required="">
            </div>
        </div>
    </div>
    <div class="row">
        <div class="col-md-12">
            <div class="mb-3">
                ...
                <input type="text" name="satuan" class="form-control" id="username" required="">
            </div>
        </div>
    </div>
    <div class="row">
        <div class="col-sm-12 text-end">
            ...
            <button type="submit" class="btn btn-primary px-4">Buat Bahan</button>
        </div>
    </div>
</form>
